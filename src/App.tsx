...
import { Heart, Users, ArrowRight, Check, Star, MessageCircle, Calendar, MapPin, Sparkles, Home, Bell, ArrowLeft, Music, Film, BookOpen, Utensils, ShoppingBag, Smartphone, Plane, Trophy, Palette, Coffee, Gamepad2, Camera, Globe, Map, Car, Bus, Train, Wifi, Zap, Shield, Lock, Eye, TrendingUp, Award, Users2, MessageSquare, HeartHandshake, Search, Play, Bookmark, Video, Briefcase, PenTool, User } from 'lucide-react';
  ...
  return (
    <ChatProvider userId={userId}>
      ...
      <Routes>
        ...
        <Route path="/register" element={<RegistrationForm onBack={() => window.location.href = '/'} />} />
        <Route path="/universe-selection" element={<UniverseSelection 
          onSelectUniverse={(universe) => {
            if (universe === 'love') window.location.href = '/love-dashboard';
            if (universe === 'friends') window.location.href = '/friends-dashboard';
          }}
          onBack={() => window.location.href = '/'}
        />} />
        <Route path="/love-dashboard" element={<LoveDashboard userId={userId} onNavigate={(page) => {
          if (page === 'landing') window.location.href = '/';
          if (page === 'registration') window.location.href = '/register';
          if (page === 'universe-selection') window.location.href = '/universe-selection';
          if (page === 'friends-dashboard') window.location.href = '/friends-dashboard';
        }} />} />
        <Route path="/friends-dashboard" element={<FriendsDashboard userId={userId} onNavigate={(page) => {
          console.log('onNavigate called with:', page);
          if (page === 'landing') window.location.href = '/';
          if (page === 'registration') window.location.href = '/register';
          if (page === 'universe-selection') window.location.href = '/universe-selection';
          if (page === 'love-dashboard') window.location.href = '/love-dashboard';
...
const LandingPage = () => {
  ...
  const handleDemoSignIn = () => {
    // Demo sign in now goes to universe selection first
  ...
  <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-pink-50">
        ...
        <div className="flex justify-between items-center py-4">
          ...
          <div className="hidden md:flex items-center space-x-4">
              <button 
                ...
                className="text-gray-600 hover:text-indigo-600 transition-colors duration-75 hover:scale-105 transition-transform flex items-center space-x-2 group relative"
                title="Click to explore the dashboard in demo mode"
              >
                <span>Sign In</span>
                <span className="text-xs bg-indigo-100 text-indigo-700 px-2 py-1 rounded-full opacity-0 group-hover:opacity-100 transition-opacity">
                  Demo
                </span>
            </button>
            <button 
                onClick={handleGetStarted}
              className="bg-gradient-to-r from-indigo-600 to-pink-600 text-white px-6 py-2 rounded-full hover:shadow-lg transition-all duration-300 transform hover:scale-105"
            >
              Get Started
            </button>
          </div>
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden border-t border-gray-200 py-4">
            <div className="flex flex-col space-y-4">
              <button 
                onClick={handleDemoSignIn}
                className="text-left text-gray-600 hover:text-indigo-600 transition-colors duration-75 py-2 px-4 rounded-lg hover:bg-gray-50 flex items-center justify-between group"
              >
                <span>Sign In</span>
              ...
              <button 
                onClick={handleGetStarted}
                className="bg-gradient-to-r from-indigo-600 to-pink-600 text-white px-6 py-3 rounded-lg hover:shadow-lg transition-all duration-300 transform hover:scale-105 text-center w-full"
              >
                Get Started
              </button>
            </div>
    ...
    <section className="relative py-12 sm:py-16 md:py-20 lg:py-24 px-6 sm:px-8 lg:px-12 xl:px-16 overflow-hidden">
      ...
      <div className="relative max-w-6xl mx-auto text-center">
        <div className="inline-flex items-center space-x-2 bg-white/80 backdrop-blur-sm px-4 sm:px-6 py-2 sm:py-3 rounded-full shadow-lg border border-gray-200 mb-6 sm:mb-8 animate-pulse">
        ...
        <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center px-4">
          <button 
            onClick={handleGetStarted}
            className="bg-gradient-to-r from-indigo-600 to-pink-600 text-white px-6 sm:px-8 py-3 sm:py-4 rounded-full text-base sm:text-lg font-semibold hover:shadow-lg transition-all duration-300 transform hover:scale-105"
          >
            Get Started
          </button>
          <button 
            onClick={handleDemoSignIn}
            className="bg-white text-gray-900 border-2 border-gray-200 px-6 sm:px-8 py-3 sm:py-4 rounded-full text-base sm:text-lg font-semibold hover:border-indigo-300 hover:bg-indigo-50 transition-all duration-300 transform hover:scale-105"
          >
            Try Demo
          </button>
        </div>
    ...
    <section className="py-12 sm:py-16 md:py-20 px-6 sm:px-8 lg:px-12 xl:px-16 bg-gradient-to-br from-indigo-50 via-white to-pink-50 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center mb-16 sm:mb-20">
          <div className="inline-flex items-center space-x-2 bg-gradient-to-r from-pink-100 to-blue-100 px-4 sm:px-6 py-3 sm:py-4 rounded-full mb-6 sm:mb-8 shadow-lg">
          ...
          <p className="text-lg sm:text-xl md:text-2xl text-gray-600 max-w-3xl sm:max-w-4xl mx-auto leading-relaxed">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8 mb-12 sm:mb-16">
          <div className="bg-white rounded-full p-6 sm:p-8 shadow-lg hover:shadow-xl transition-all duration-150 transform hover:-translate-y-2 border border-gray-100 relative overflow-hidden">
    ...
    <section className="py-12 sm:py-16 md:py-20 px-6 sm:px-8 lg:px-12 xl:px-16 bg-white relative overflow-hidden">
      
      
      <div className="max-w-7xl mx-auto relative z-10">
                 {/* Header Section - More section-like */}
         <div className="mb-12 sm:mb-16">
           <div className="inline-flex items-center space-x-2 bg-gradient-to-r from-pink-100 to-blue-100 px-3 sm:px-4 py-2 sm:py-3 rounded-full mb-4 sm:mb-6 shadow-sm">
              <Sparkles className="w-4 h-4 sm:w-5 sm:h-5 text-pink-600" />
              <span className="text-xs sm:text-sm font-semibold text-pink-700">Your Perfect Match Awaits</span>
            </div>
    ...
    <section className="py-12 sm:py-16 md:py-20 px-6 sm:px-8 lg:px-12 xl:px-16 bg-gradient-to-br from-indigo-50 via-white to-pink-50">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12 sm:mb-16">
          <div className="inline-flex items-center space-x-2 bg-gradient-to-r from-pink-100 to-blue-100 px-3 sm:px-4 py-2 rounded-full mb-4 sm:mb-6">
            <Sparkles className="w-4 h-4 sm:w-5 sm:h-5 text-pink-600" />
            <span className="text-xs sm:text-sm font-semibold text-pink-700">Core Features</span>
          </div>
    ...
    <section className="py-12 sm:py-16 md:py-20 lg:py-24 px-6 sm:px-8 lg:px-12 xl:px-16 bg-white">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12 sm:mb-16">
          <div className="inline-flex items-center space-x-2 bg-gradient-to-r from-pink-100 to-blue-100 px-3 sm:px-4 py-2 rounded-full mb-4 sm:mb-6">
            <Star className="w-4 h-4 sm:w-5 sm:h-5 text-pink-600" />
            <span className="text-xs sm:text-sm font-semibold text-pink-700">Why Choose Us</span>
          </div>
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-4 sm:mb-6">
    ...
    <section className="py-12 sm:py-16 md:py-20 px-6 sm:px-8 lg:px-12 xl:px-16 bg-gradient-to-br from-indigo-50 via-white to-pink-50">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12 sm:mb-16">
          <div className="inline-flex items-center space-x-2 bg-gradient-to-r from-pink-100 to-blue-100 px-3 sm:px-4 py-2 rounded-full mb-4 sm:mb-6">
            <Sparkles className="w-4 h-4 sm:w-5 sm:h-5 text-pink-600" />
            <span className="text-xs sm:text-sm font-semibold text-pink-700">Simple Process</span>
          </div>
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-4 sm:mb-6">
            How BrandBond Works
          </h2>
    ...
    <section className="py-20 px-6 sm:px-8 lg:px-12 xl:px-16 bg-white relative overflow-hidden">
      <div className="absolute inset-0">
      ...
      <div className="max-w-4xl mx-auto text-center relative z-10">
        <div className="inline-flex items-center space-x-2 bg-gradient-to-r from-pink-100 to-blue-100 px-3 sm:px-4 py-2 rounded-full mb-4 sm:mb-6">
          ...
          <span className="text-xs sm:text-sm font-semibold text-pink-700">Get Started Today</span>
        </div>
        <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-4 sm:mb-6">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <button 
              onClick={handleDemoSignIn}
              className="bg-gradient-to-r from-indigo-600 to-pink-600 text-white px-8 py-4 rounded-full text-lg font-semibold hover:shadow-lg transition-all duration-300 transform hover:scale-105"
          >
              Try Demo
          </button>
        <button 
            onClick={handleGetStarted}
            className="bg-white text-gray-900 border-2 border-gray-200 px-8 py-4 rounded-full text-lg font-semibold hover:border-indigo-300 hover:bg-indigo-50 transition-all duration-300 transform hover:scale-105"
        >
            Get Started
        </button>
        </div>
