    ...
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl p-6 border border-green-100">
        <div className="flex items-center mb-4">
          ...
          <h3 className="text-xl font-semibold text-gray-800">Security & Access</h3>
        </div>
  ...
  const renderStep2 = () => (
    <div className="space-y-6">
      ...
      <div className="bg-gray-50 rounded-lg p-4">
        ...
        <div className="w-full bg-gray-200 rounded-full h-2 mt-2">
          <div className="bg-orange-500 h-2 rounded-full" style={{ width: '28.57%' }}></div>
        </div>
      </div>
    </div>
  );
  ...
  const renderStep5 = () => (
    <div className="space-y-6">
      <div className="text-center mb-8">
        ...
        <p className="text-gray-600">Show the real you! Upload up to 6 photos for your profile</p>
      </div>
            ...
            <div key={index} className="relative">
              ...
              <div className="relative group">
                {data.photos[index] ? (
                  ...
                  <div className="w-full h-32 border-2 border-dashed border-gray-300 rounded-lg flex flex-col items-center justify-center bg-gray-50 hover:bg-gray-100 transition-colors cursor-pointer group">
      ...
      <div className="bg-gray-50 rounded-lg p-4">
        ...
        <div className="w-full bg-gray-200 rounded-full h-2 mt-2">
          <div className="bg-purple-500 h-2 rounded-full" style={{ width: '71.43%' }}></div>
        </div>
      </div>
    </div>
  );
  ...
  const renderStep6 = () => (
    <div className="space-y-6">
      <div className="text-center mb-8">
        ...
        <p className="text-gray-600">Review your information before creating your profile</p>
      </div>
