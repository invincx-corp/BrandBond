...
import { Users, Heart, MessageCircle, Calendar, Star, Plus, Search, Video, FileText, MapPin, ThumbsUp, ThumbsDown, Share2, Bookmark, Image, Music, Globe, BarChart3, Activity, Bell, Hash, Play, TrendingUp } from 'lucide-react';
                ...
                {members.slice(0, 3).map((member) => (
                  <div key={member.id} className="flex items-center space-x-3 p-3 rounded-xl hover:bg-blue-50 transition-all duration-200">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-xs text-blue-600 bg-blue-100 px-2 py-0.5 rounded-full inline-block">{member.matchPercentage}% match</p>
