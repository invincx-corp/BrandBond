...
const IntelligentAIPrompts: React.FC<IntelligentAIPromptsProps> = ({
  ...
  return (
    <div className={`mb-3 p-2 rounded-lg border shadow-md ${
      theme === 'friends' 
       ...
       <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
        {filteredPrompts.map((prompt) => (
                           <div
           key={prompt.id}
           className={`p-2 rounded-lg border transition-all cursor-pointer hover:shadow-md min-h-[100px] flex flex-col justify-between ${
             theme === 'friends' 
