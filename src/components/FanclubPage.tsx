...
import { Users, Heart, MessageCircle, Calendar, Star, Plus, Search, Video, FileText, MapPin, ThumbsUp, ThumbsDown, Share2, Bookmark, Image, Music, Globe, BarChart3, Activity, Bell, Hash, Play, Trophy, TrendingUp, Award, BookOpen, Zap } from 'lucide-react';
                ...
                {members.slice(0, 3).map((member) => (
                  <div key={member.id} className="flex items-center space-x-3 p-3 rounded-xl hover:bg-purple-50 transition-all duration-200">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-xs text-pink-600 bg-pink-100 px-2 py-0.5 rounded-full inline-block">{member.matchPercentage}% match</p>
